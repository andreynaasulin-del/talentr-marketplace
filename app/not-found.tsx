        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-6">
            <div className="max-w-lg w-full text-center">
                ...
                <div className="relative mb-8">
                    <h1 className="text-[200px] font-black text-gray-100 leading-none select-none">
                        404
                    </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white border border-gray-200 text-gray-700 font-bold rounded-2xl hover:bg-gray-50 transition-all"
                    >
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                    <p className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-4">Quick Links</p>
                    <div className="flex flex-wrap justify-center gap-4">
                        ...
                        <Link href="/join" className="text-blue-600 hover:underline font-medium">Join as Vendor</Link>
                    </div>
                </div>
            </div>
        </div>
