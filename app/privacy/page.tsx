                ...
                <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        <div className="p-4 bg-blue-50 rounded-2xl text-center">
                            ...
                            <p className="text-sm font-bold text-blue-900">Transparent</p>
                            <p className="text-xs text-blue-600">We tell you what we collect</p>
                        </div>
                        <div className="p-4 bg-green-50 rounded-2xl text-center">
                            <Lock className="w-6 h-6 text-green-600 mx-auto mb-2" />
                            <p className="text-sm font-bold text-green-900">Secure</p>
                        ...
                        <div className="p-4 bg-purple-50 rounded-2xl text-center">
                            ...
                            <p className="text-sm font-bold text-purple-900">Minimal</p>
                            <p className="text-xs text-purple-600">We only collect what we need</p>
                        </div>
                    </div>
                    ...
                    <section>
                        ...
                        <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                            ...
                            <a href="mailto:privacy@talentr.app" className="text-blue-600 font-medium hover:underline">
                                privacy@talentr.app
                            </a>
                        </div>
                    </section>
