        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12 space-y-8">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Vendor Responsibilities</h2>
                        <ul className="list-disc list-inside text-gray-600 space-y-2">
                    ...
                    <section>
                        ...
                        <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                            ...
                            <a href="mailto:support@talentr.app" className="text-blue-600 font-medium hover:underline">
                                support@talentr.app
                            </a>
                        </div>
                    </section>
