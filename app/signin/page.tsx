                ...
                <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
                    ...
                    <div className="max-w-md">
                        ...
                        <p className="text-xl text-white/80 mb-8">
                            Connect with top-rated professionals and make your events unforgettable.
                        </p>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="space-y-3 mb-6">
                        <button
                            ...
                            className="w-full h-14 bg-white border-2 border-gray-200 rounded-xl font-semibold text-gray-700 hover:border-gray-300 hover:bg-gray-50 transition-all flex items-center justify-center gap-3"
                        >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full h-14 btn-primary text-lg flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
