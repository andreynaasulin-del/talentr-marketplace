...
export default function AccessibilityWidget() {
    ...
    useEffect(() => {
        ...
        // Apply Readable Font (Arial/System)
        if (readableFont) {
    ...
    return (
        <div className={`fixed bottom-4 z-[9999] font-sans ${isHebrew ? 'right-4' : 'left-4'}`}>
            ...
            <style jsx global>{`
                .high-contrast-mode {
                    filter: contrast(130%) grayscale(100%) !important;
                }
                        ...
                        <div className="p-4 space-y-3 sm:space-y-4 max-h-[60vh] overflow-y-auto">
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                <button
                                    ...
                                    className={`flex items-center justify-between p-3 rounded-xl transition-all border ${contrast ? 'bg-blue-600 text-white border-blue-600 shadow-md transform scale-[1.02]' : 'bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-300 border-zinc-200 dark:border-zinc-700'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex items-center justify-between p-3 rounded-xl transition-all border ${highlightLinks ? 'bg-blue-600 text-white border-blue-600 shadow-md transform scale-[1.02]' : 'bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-300 border-zinc-200 dark:border-zinc-700'
                                        }`}
                                >
                                    <div className="flex items-center gap-3">
                                ...
                                <button
                                    ...
                                    className={`flex items-center justify-between p-3 rounded-xl transition-all border ${readableFont ? 'bg-blue-600 text-white border-blue-600 shadow-md transform scale-[1.02]' : 'bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-300 border-zinc-200 dark:border-zinc-700'
                                        }`}
                                >
                                    <div className="flex items-center gap-3">
